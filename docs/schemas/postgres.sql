...
create table public.field (
  ...
  "field_column" varchar(255) not null default '',
...
create index idx_field_column on public.field (field_column);
...
create table public.comment (
  ...
  "comment_author_ip" inet not null default '0.0.0.0',
  "comment_author_agent" varchar(255) not null default '',
